...
var Juego = {
    ...
    obstaculosCarretera: [
        ...
        //Vallas
        new Obstaculo('imagenes/valla_vertical.png', 70, 430, 30, 30, 1),
        new Obstaculo('imagenes/valla_horizontal.png', 160, 360, 30, 30, 1),
        new Obstaculo('imagenes/valla_horizontal.png', 800, 180, 30, 30, 1),
        new Obstaculo('imagenes/valla_horizontal.png', 840, 440, 30, 30, 1),
        new Obstaculo('imagenes/valla_vertical.png', 260, 430, 30, 30, 1),
        new Obstaculo('imagenes/valla_vertical.png', 530, 430, 30, 30, 1),
        new Obstaculo('imagenes/valla_vertical.png', 520, 110, 30, 30, 1),
        //Baches
        new Obstaculo('imagenes/bache.png', 150, 470, 30, 30, 1),
        new Obstaculo('imagenes/bache.png', 450, 470, 30, 30, 1),
        new Obstaculo('imagenes/bache.png', 350, 200, 30, 30, 1),
        new Obstaculo('imagenes/bache.png', 830, 180, 30, 30, 1),
        //Autos Verdes
        new Obstaculo('imagenes/auto_verde_abajo.png', 400, 390, 15, 30, 2),
        new Obstaculo('imagenes/auto_verde_derecha.png', 460, 210, 30, 15, 2),
        new Obstaculo('imagenes/auto_verde_abajo.png', 280, 150, 15, 30, 2),
        new Obstaculo('imagenes/auto_verde_derecha.png', 730, 80, 30, 15, 2),
        new Obstaculo('imagenes/auto_verde_derecha.png', 770, 440, 30, 15, 2),
    ...
    enemigos: [
        ...
        //Caminantes
        new ZombieCaminante('imagenes/zombie2.png', 540, 240, 10, 10, 2, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }),
        new ZombieCaminante('imagenes/zombie2.png', 100, 370, 10, 10, 2, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }),
        new ZombieCaminante('imagenes/zombie1.png', 330, 480, 10, 10, 1, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }),
        new ZombieCaminante('imagenes/zombie3.png', 290, 90, 10, 10, 3, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }),
        new ZombieCaminante('imagenes/zombie1.png', 820, 110, 10, 10, 1, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }),

        //Conductores
        new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 5, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }, "v"),
        new ZombieConductor('imagenes/tren_vertical.png', 678, 500, 30, 90, 7, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }, "v"),
        new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 10, { desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577 }, "h"),

    ],

    //Las vidas que curan al jugar al hacer contacto.
    vidas: [
        new Vida('imagenes/heart.png', 540, 310, 20, 20, 1),
        new Vida('imagenes/heart.png', 850, 100, 20, 20, 1)
...
Juego.dibujar = function() {
    ...
    //Se recorren las vidas pintandolas.
    this.vidas.forEach(function(vida) {
        Dibujante.dibujarEntidad(vida);
    });

    //Se dibuja la linea de llegada.
    Dibujante.dibujarRectangulo('blue', 750, 525, 145, 40);
...
Juego.chequearColisiones = function(x, y) {
    ...
    //Si el jugador pasa sobre una vida este lo cura, pero le permite continuar
    // moviendose.
    this.vidas.forEach(function(vida) {
        if (this.intersecan(vida, this.jugador, x, y)) {
            ...
            //Al utilizar la vida su sprite cambia a un corazon oscuro.
            vida.sprite = 'imagenes/heart_used.png';
        }
    }, this)
    return puedeMoverse
};
